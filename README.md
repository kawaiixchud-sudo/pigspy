...
Configure your stream URL in `config.py`:
```python
...
This tool is for educational and research purposes only. Ensure you comply with all local laws
and regulations regarding scanner monitoring. this was all vibe coded and i am a complete fool please help 
